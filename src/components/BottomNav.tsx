...
const BottomNav = () => {
  ...
  // Hide nav on document viewer
  if (location.pathname.startsWith("/document/")) return null;
            ...
            return (
              <button key={tab.path} onClick={() => navigate(tab.path)}
                ...
                <div className="relative">
                  {isActive && (
                    <motion.div layoutId="nav-indicator" className="absolute -inset-2 rounded-xl bg-primary/10"
